...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    getDetail: function getDetail(mySlug) {
      var _this = this;
      axios.get('/api/posts/' + mySlug).then(function (res) {
        _this.detailPost = res.data;
      });
    }
  },
...
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c("main", [_c("h1", [_vm._v("Lista Piatti")]), _vm._v(" "), _c("ul", _vm._l(_vm.listaPost, function (piatto) {
    return _c("li", {
      key: piatto.id
    }, [_vm._v(_vm._s(piatto.title) + "\n            "), _c("a", {
      attrs: {
        href: "#"
      },
      on: {
        click: function click($event) {
          return _vm.getDetail(piatto.slug);
        }
      }
    }, [_vm._v("Vedi")]), _vm._v(" "), _vm.detailPost ? _c("span", [_vm._v(_vm._s(_vm.detailPost.slug))]) : _vm._e()]);
  }), 0)]);
};
var staticRenderFns = [];
render._withStripped = true;
